...
/**
 * Meta information for an Kind for if the key is optional or required, and if the key is remapped
 *
 * @since 1.3.0
 * @category Model
 */
...
/**
 * Meta information for an Kind2 for if the key is optional or required, and if the key is remapped
 *
 * @since 1.3.0
 * @category Model
 */
...
/**
 * Indicate that a property is required
 *
 * @since 1.3.0
...
/**
 * Indicate that a property is optional
 *
 * @since 1.3.0
 * @category Constructors
 */
...
/**
 * Remap an input key to an output key
 *
 * @since 1.3.0
