  ...
  _.createInterfaceDeclaration(
    ...
    [
      _.createHeritageClause(ts.SyntaxKind.ExtendsKeyword, [
        _.createExpressionWithTypeArguments(_.createIdentifier(`Schemable${suffix}`), [
  ...
  return pipe(
    [
      ...
      makeDestructureImport(
        ['Schemable', 'Schemable1', 'Schemable2C'],
        'io-ts/Schemable'
      ),
...
export const moduleHeaderComment: (module: string) => ts.JSDoc = module =>
  _.createJSDocComment(
    `SchemableExt intstances for ${module}\n\n**Warning: DO NOT EDIT, this module is autogenerated**\n\n@since 0.0.1`
  )
